...
performance of models fit to spatial data by providing ergonomic tools to 
assess the spatial dependence of model residuals, to assess model predictions 
across multiple scales, and to calculate the area of applicability of a model.

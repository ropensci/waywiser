...
The goal of waywiser is to make it easier to assess spatial
autocorrelation in model residuals when fitting models in the tidymodels
framework. It is highly experimental and not guaranteed to work.
